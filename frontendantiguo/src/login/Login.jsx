...
export default function Login() {
  ...
  const submit = async (e) => {
    ...
    console.log("Formulario enviado:", form); // Verificar que los datos sean correctos
    ...
    try {
      ...
      console.log("Rol recibido:", data.rol);  // Verifica el valor de 'rol'
      ...
      // Redirección por rol:
      const rol = (data.usuario && data.usuario.rol) || "usuario"; // Convertir y limpiar el rol
      console.log("Rol recibido después de limpiar:", rol);  // Verifica el rol final

      // Comparación mejorada con roles comunes
